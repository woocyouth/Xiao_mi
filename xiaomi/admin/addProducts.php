...
<article>
    <div class="box">
        ...
        <div class="inp">
            <input type="text" name="username" placeholder="商品名称" id="username"><br>
            <input type="password" name="password" placeholder="商品价格" id="password"><br>
            <input type="text" name="phone" placeholder="商品图片" id="phone"><br>
