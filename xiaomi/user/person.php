...
<head>
    <meta charset="UTF-8">
    <title>Title</title>
    <link type="text/css" rel="stylesheet" href="../CSS/user/person.css">
</head>
<body>
<!--       顶部登录栏-->
<header>
...
<article>
    <div class="contain">
        <div class="side-contain">
            <div class="menu-nav">
                <h3>订单中心</h3>
                <ul class="side-menu-nav-ul">
                    <li>
                        <a href="myOrderList.php" target="per_Frame">我的订单</a>
                    </li>
                    <li>
                        <a href="#" target="per_Frame">意外保</a>
                    </li>
                    <li>
                        <a href="#" target="per_Frame">团购订单</a>
                    </li>
                    <li>
                        <a href="#" target="per_Frame">评价晒单</a>
                    </li>
                    <li>
                        <a href="#" target="per_Frame">话费充值订单</a>
                    </li>
                    <li>
                        <a href="#" target="per_Frame" class="col">以旧换新订单</a>
                    </li>
                </ul>
            </div>
            ...
            <div class="menu-nav">
                ...
                <ul class="side-menu-nav-ul">
                    <li>
                        <a href="person_show.php" target="per_Frame">我的个人中心</a>
                    </li>
                    <li>
                        <a href="#" target="per_Frame">消息通知</a>
                    </li>
                    <li>
                        <a href="#" target="per_Frame">购买资格</a>
                    </li>
                    <li>
                        <a href="#" target="per_Frame">现金账户</a>
                    </li>
                    <li>
                        <a href="#" target="per_Frame">现金券</a>
                    </li>
                    <li>
                        <a href="#" target="per_Frame">优惠券</a>
                    </li>
                    <li>
                        <a href="#" target="per_Frame">收货地址</a>
                    </li>
                    <li>
                        <a href="#" target="per_Frame">红包</a>
                    </li>
                </ul>
            </div>
            ...
            <div class="menu-nav">
                ...
                <ul class="side-menu-nav-ul">
                    <li>
                        <a href="#" target="per_Frame">服务记录</a>
                    </li>
                    <li>
                        <a href="#" target="per_Frame">申请服务</a>
                    </li>
                    <li>
                        <a href="#" target="per_Frame">领取快递报销</a>
                    </li>
                </ul>
            </div>
            ...
            <div class="menu-nav">
                ...
                <ul class="side-menu-nav-ul">
                    <li>
                        <a href="person_show.html" target="per_Frame">个人信息</a>
                    </li>
                    <li>
                        <a href="#" target="per_Frame">修改密码</a>
                    </li>
        ...
        <div class="right-contain">
            <iframe name="per_Frame" src="" id="per_FrameID"></iframe>
        </div>
    </div>
</article>
...
<script>
    ...
    sear_btn.addEventListener('click', function () {
        window.location = "shop_list_look/search_list.php?p_name=" + search_value.value + "&search=" + search_value.value;
    });
