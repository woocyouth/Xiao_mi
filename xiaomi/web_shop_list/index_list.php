...
<head>
    <meta charset="UTF-8">
    <title>Title</title>
    <link type="text/css" rel="stylesheet" href="../CSS/user/web_shop_index_list.css">
</head>
<body>
<!--       顶部登录栏-->
<header>
                ...
                <div class="user-details"
                    ...
                    <div class="details">
                        ...
                        <ul class="details-ul">
                            ...
                            <li><a href="#">我都喜欢</a></li>
                            <li><a href="#">小米账户</a></li>
                            <li><a href="../user/doUserAction.php?act=logout">退出登录</a></li>
                        </ul>
                    </div>
                    <span>|</span>
                    <a href="#">消息通知</a>
...
<div class="shop-contain">
    <div class="title">
        <div class="title-txt">
            <h2 class="txt-show" id="txt_show" href="#">小米10&nbsp;Pro</h2>
            <span>|</span>
            <a class="txt-show-other" id="txt_other" href="product/xm10_list.php" target="contain_iframe">小米10</a>
        </div>

        <div class="right">
            <a href="#">概述</a><span class="right-sep">|</span>
            <a href="#">参数</a><span class="right-sep">|</span>
            <a href="#">F码通道</a><span class="right-sep">|</span>
            <a href="#">咨询客服</a><span class="right-sep">|</span>
            <a href="#">用户评价</a><span class="right-sep">|</span>
            <div class="buy_now">
...
<div class="shop-container">
    <!--    <a href="" target="contain_iframe">test</a>-->
    <div class="frame-show">
        <iframe id="external-frame" frameborder="0" name="contain_iframe" src="" style="border: none;width: 100%;"></iframe>
    </div>
...
<!--thought-price-->
<div class="thought">
    <div class="thought-price">
        <h2 class="title">价格说明</h2>
        <img src="../image/huaxianjia.jpg" width="1230" height="190">
    </div>
</div>
...
<script src="../js/index_list.js"></script>
<script>
    var url=location.search.substring(1);
    // alert(url);
    // iframe 容器不存在时，会自动创建
    // if(url)document.write('<iframe src="'+url+'"></iframe>')
    //如果存在iframe容器，这些代码放在iframe下，改为if(url)document.getElementById('iframe的id').src=url
    if(url)document.getElementById('external-frame').src=url;
    ...
    sear_btn.addEventListener('click',function () {
        window.location = "../user/shop_list_look/search_list.php?p_name="+search_value.value+"&search="+search_value.value;
    });
...
<script>
    ...
    // }
    //根据ID获取iframe对象
    var ifr = document.getElementById('external-frame');
    ifr.onload = function() {
        //解决打开宽高太高或太宽的页面后再打开高度宽度较小页面滚动条不收缩
