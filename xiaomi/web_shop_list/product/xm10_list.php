...
<head>
    <meta charset="UTF-8">
    <title>Title</title>
    <link rel="stylesheet" href="../../CSS/product/xm10_list.css">
...
<div class="contain">
    ...
    <div class="pro-info">
        ...
        <p class="info">
            <span class="info">「现货热卖中，信用卡分期享24期免息，低至167元起/期，+1元限量得保护壳，购8GB/12GB+256GB赠价值89元双单元半入耳式耳机Type-C版，加购立式风冷无线充立省50元，加购冰封散热背夹立省30元，加购小米圈铁四单元耳机立省150元」</span>
        ...
        <div class="price">
            <span class="now_price">4299元</span>
        </div>
        <!--  user address-->
        <div class="address">
        ...
        <div class="list-wrap">
            ...
            <div class="choose-color">
                ...
                <ul class="choose-col-ul">
                    <li class="c-active">
                        <img class="c-img" src="../../image/xm10_change_1.jpg" width="16" height="16">
                        <span class="col-name ">冰海蓝</span>
                    </li>
                    <li>
                        <img class="c-img" src="../../image/xm10_change_1_black.jpg" width="16" height="16">
                        <span class="col-name ">钛银黑</span>
                    </li>
                </ul>
            </div>
            <!--        insurance-->
        ...
        <div class="pro-list">
            <ul class="pro-list-ul">
                <li>
                    <span id="good-name">小米10</span>
                    <span class="version">8GB+256GB</span>
                    <span class="color">冰海蓝</span>
                    <span class="money">3299 元</span>
                </li>
